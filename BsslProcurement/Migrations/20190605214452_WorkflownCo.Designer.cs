...
namespace BsslProcurement.Migrations
{
    ...
    [Migration("20190605214452_WorkflownCo")]
    partial class WorkflownCo
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DcProcurement.CompanyInfo", b =>
                {
                    ...
                    b.Property<int>("PrequalificationTaskId");
            ...
            modelBuilder.Entity("DcProcurement.Vendor", b =>
                {
                    b.HasBaseType("DcProcurement.User");
            ...
            modelBuilder.Entity("DcProcurement.PrequalificationJob", b =>
                {
                    b.HasOne("DcProcurement.CompanyInfo", "CompanyInfo")
                        .WithOne("PrequalificationJob")
                        .HasForeignKey("DcProcurement.PrequalificationJob", "CompanyInfoId")
                        .OnDelete(DeleteBehavior.Cascade);
            ...
            modelBuilder.Entity("DcProcurement.Vendor", b =>
                {
                    b.HasOne("DcProcurement.CompanyInfo", "CompanyInfo")
                        .WithOne("Vendor")
                        .HasForeignKey("DcProcurement.Vendor", "CompanyInfoId");
                });
